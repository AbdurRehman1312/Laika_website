...
const Token = () => {
  return (
    <section id="laikatoken" className="my-48">
      <h2 className="text-primary">{">"} $LAIKA Token</h2>
      <div className="flex flex-col justify-center items-center gap-10 text-center h-[70vh] sm:h-[40vh]">
        <h1 className="text-white font-semibold text-5xl sm:text-4xl md:text-6xl">
          Discover <span className="text-gradient">$LAIKA</span> Token
        </h1>
        <p className="text-dimGrey text-center w-[65%]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-32 my-6 md:my-10 lg:my-12">
        <div className="col-span-1 md:col-span-4">
          <div className="flex flex-col justify-center bg-dark-gradient h-[370px] rounded-[20px] p-5">
        ...
        <div className="col-span-1 md:col-span-8">
          <div className="flex flex-col gap-5 w-[60%] border-dashed border-b border-gray-500 pb-4">
            ...
            <Button name="See Docs" style="w-[25%]" />
          </div>
          <div className="grid grid-cols-2 mt-4">
            <div className="flex flex-col gap-3 ">
              ...
              <div className="relative">
                <input
                  className="bg-dark-gradient text-white px-3 h-[35px] rounded-[5px] w-[60%] focus:outline-none"
                  type="text"
                ...
                <button>
                  <img
                    ...
                    alt=""
                    className="absolute right-[170px] top-[20%] w-7 h-7"
                  />
                </button>
              </div>
            </div>
            <div className="flex flex-col gap-4">
              <h2 className="text-white font-semibold text-xl flex gap-2">
                Spread some <img src={images.dog} className="w-6 h-6" alt="" />{" "}
              </h2>
              <p className="text-dimGrey">Spread some what?</p>
              <div className="bg-dark-gradient py-3 px-4 rounded-[10px] w-[40%] text-center text-lg">
              🦴🦴🦴🦴🦴🦴
              </div>
            </div>
          </div>
